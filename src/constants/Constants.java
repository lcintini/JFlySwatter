...
public class Constants {
    public static final String TITLE = "JFlySwatter";
    public static final int BOARD_WIDTH = 640; // le dimensioni 4/3 (480p)
    ...
    public static final int WASP_HEIGHT = 52;
    public static final int WASP_WIDTH = 34;
    public static final int BUTTERFLY_HEIGHT = 48;
    ...
    public static final String BOMB_FONT_PATH = "resources/font/TheBomb.ttf";
}
